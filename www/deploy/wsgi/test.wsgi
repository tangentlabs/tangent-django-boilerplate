...
# Project root
root = '/var/www/{{ client }}/{{ project_code }}/builds/test/'
sys.path.insert(0, root)

# Packages from virtualenv
activate_this = '/var/www/{{ client }}/{{ project_code }}/virtualenvs/test/bin/activate_this.py'
execfile(activate_this, dict(__file__=activate_this))

# Set environmental variable for Django and fire WSGI handler 
os.environ['DJANGO_SETTINGS_MODULE'] = 'settings'
os.environ['DJANGO_CONF'] = 'conf.test'
